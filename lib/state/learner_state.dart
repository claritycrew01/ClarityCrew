  ...
  Future<void> updateAccessibility({
    ...
    _profile = _profile.copyWith(
      prefersReducedMotion:
          reducedMotion ?? _profile.prefersReducedMotion,
      prefersReducedVisuals:
          reducedVisuals ?? _profile.prefersReducedVisuals,
      prefersHighContrast:
          highContrast ?? _profile.prefersHighContrast,
      lineSpacing: lineSpacing ?? _profile.lineSpacing,
      fontSizeMultiplier:
          fontSizeMultiplier ?? _profile.fontSizeMultiplier,
      lastUpdated: DateTime.now(),
    );
    await _repo.saveLearnerProfile(_profile);
    notifyListeners();
